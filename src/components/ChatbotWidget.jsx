...
export default function ChatbotWidget() {
  ...
  return (
    <div className="wrap">
      ...
      {open && (
        <div
          className={`cb-overlay ${closing ? "is-closing" : ""}`}
          onClick={handleClose}
        />
      )}
      ...
      {open && (
        <div
          className={`cb-panel ${closing ? "is-closing" : ""}`}
          role="dialog"
          aria-label="챗봇"
        >
          {/* === View: CHAT === */}
            ...
            <>
              <div className="cb-head">
                <button className="cb-back" onClick={handleClose}>
                  <span className="cb-back-icon">
                    <img src="/img/chatbot-back.svg" alt="" />
                  </span>
                  Chat
                </button>
                    ...
                    <div className="cb-menu">
                      <button onClick={askEndChat}>
                        <span className="cb-menu-icon">
                          <img src="/img/chatbot-plus.svg" alt="" />
                        </span>{" "}
                        새 대화 시작하기
                      </button>
                      <button onClick={handleRecentChats}>
                        <span className="cb-menu-icon">
                          <img src="/img/chatbot-clock.svg" alt="" />
                        </span>{" "}
                        최근 대화한 채팅
                      </button>
                    </div>
              ...
              <div className="cb-body" ref={bodyRef}>
                ...
                {messages.map((m, idx) => (
                  <div
                    key={idx}
                    className={`cb-msg ${m.role === "user" ? "is-user" : "is-bot"}`}
                  >
                    <div className="cb-bubble">
                      {m.role === "bot" && (
                        <div className="cb-bot-name">Dugout</div>
                      )}
                      {m.text}
                    </div>
                  </div>
            ...
            <>
              <div className="cb-head">
                <button className="cb-back" onClick={() => setView("chat")}>
                  <span className="cb-back-icon">
                    <img src="/img/chatbot-back.svg" alt="back" />
                  </span>
                  Chat
                </button>
              ...
              <div className="cb-recent-body">
                ...
                <div className="cb-no-recent">
                  <p>최근 대화 내역이 없습니다.</p>
                  <p className="cb-sub-text">
                    챗봇은 실시간 상담이 아닌 정보 안내용 입니다.
                  </p>
                </div>
              </div>
            </>
              ...
              <div className="cb-modal">
                <div className="cb-modal-content">
                  ...
                  <p className="cb-modal-desc">
                    종료 시 모든 대화 내용이 삭제됩니다.
                  </p>
                </div>
                <div className="cb-modal-actions">
                  <button
                    className="cb-modal-btn cancel"
                    onClick={cancelEndChat}
                  >
                    취소
                  </button>
                  <button className="cb-modal-btn ok" onClick={confirmEndChat}>
                    종료하기
                  </button>
                </div>
              </div>
