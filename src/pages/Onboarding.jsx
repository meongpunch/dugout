...
const Onboarding = () => {
  ...
  const onStart = (x) => {setStartX(x); setIsDown(true); };
  ...
  const commonProps = {page,goNext,goTo,handleTouchStart,handleTouchEnd,handleMouseDown,handleMouseUp,};
...
const Container = ({children,handleTouchStart,handleTouchEnd,handleMouseDown,handleMouseUp,}) => 
  (
  <div
...
// Onboarding 1 
const Onboarding1 = ({page,goNext,goTo,handleTouchStart,handleTouchEnd,handleMouseDown,handleMouseUp,}) => 
  (
  <Container
  ...
  >
    ...
    <button className="skip" type="button">건너뛰기</button>
...
// Onboarding 2
const Onboarding2 = ({page, goNext, goTo, handleTouchStart, handleTouchEnd, handleMouseDown,handleMouseUp,}) => 
  (
  <Container
    handleTouchStart={handleTouchStart}
    handleTouchEnd={handleTouchEnd}
...
// Onboarding 3
const Onboarding3 = ({page, goNext, goTo, handleTouchStart, handleTouchEnd, handleMouseDown,handleMouseUp,}) => (
  <Container
    handleTouchStart={handleTouchStart}
    handleTouchEnd={handleTouchEnd}
    handleMouseDown={handleMouseDown}
...
// Onboarding 4
const Onboarding4 = ({page, goNext, goTo, handleTouchStart, handleTouchEnd, handleMouseDown, handleMouseUp,}) => 
  (
  <Container
    handleTouchStart={handleTouchStart}
    handleTouchEnd={handleTouchEnd}
